...
def generate_team_stat_leaders(req: TeamStatLeadersRequest) -> Dict[str, Any]:
    try:
        ...
        # 2) Render PNGs locally on server
        ...
        # Put these in a clean prefix so you can browse them in the bucket
        key_off = f"team_leaders/{team}/{team.lower()}_offense.png"
        key_def = f"team_leaders/{team}/{team.lower()}_defense.png"
