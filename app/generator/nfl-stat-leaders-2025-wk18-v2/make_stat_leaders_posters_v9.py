...
# ----------------------------
# String normalization (THE FIX)
# ----------------------------
def normalize_spaces(s: str) -> str:
    # remove weird/zero-width characters + normalize whitespace
    s = str(s)
...
def enforce_space_before_team(s: str) -> str:
    """
    Guarantees: 'James Cook III BUF' not 'James Cook IIIBUF'
    and 'Bobby Wagner WSH' not 'Bobby WagnerWSH'
    """
    s = normalize_spaces(s)

    # If already ends with " TEAM" it's fine; but also fixes glued endings.
    ...
    # remove any trailing punctuation/odd chars between name and team
...
# ----------------------------
# Poster drawing (same as your v8 “perfect” styling)
# ----------------------------
...
def main():
    ...
    out_off = os.path.join(desktop, f"offense_stat_leaders_{SEASON}_wk18_v9.png")
    out_def = os.path.join(desktop, f"defense_stat_leaders_{SEASON}_wk18_v9.png")

    # offense: keep your perfect sizing
